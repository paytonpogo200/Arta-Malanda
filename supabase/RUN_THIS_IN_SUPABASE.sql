...
-- Updated through checkpoint 12: auth, dashboard shell, character ledger, inventory/loadout/wallets, house/property/storage, battlemap/combat, cities/shops, spells, exploration/loot, bestiary, personal scroll, trades/notifications foundation.
