...
export const ITEM_TYPES: ItemType[] = ['weapon', 'armor', 'shield', 'pet', 'accessory', 'storage', 'material', 'catalyst', 'rune', 'ore', 'potion', 'food', 'plant', 'fabric', 'tool', 'book', 'quest', 'spell book', 'currency', 'misc'];
...
export function normalizeInventoryItem(value: unknown): InventoryItem {
  ...
  return {
    ...
    itemDescription: source.itemDescription ? String(source.itemDescription) : undefined,
