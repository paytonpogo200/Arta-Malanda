...
export const CLASS_TEMPLATES: ClassTemplate[] = [
  ...
  },
  {
    ...
    armor: 'Medium armor',
    identity: 'Apothecaries are incredibly durable mages, known for their legendary support in combat and on the battlefield. They are extremely formidable as mages, and sometimes, even in the frontline. Many a great apothecary was known for their priceless support in battle. But a few, are some of the most feared names Arda Malanda has heard.',
    inventorySlots: 15,
    spellSlots: 5,
    baseHp: 130,
    baseMana: 90,
  ...
  },
  {
    ...
    armor: 'Medium armor',
    identity: 'Apprentices are learners, and are naturally talented mages, but enjoy the freedom of some extra sustainability, as opposed to utility. Their resourcefulness is often a great contribution to many successful expeditions.',
    inventorySlots: 16,
    spellSlots: 5,
    baseHp: 100,
    baseMana: 75,
  ...
  },
  {
    ...
    armor: 'Medium armor',
    identity: 'Knights are talented swordsmen and combat experts, and pair well with horses. Well liked knights have been known to have been shown favor even when purchasing one and have a larger political sway. They are your classic all around attack type with a nice amount of sustainability.',
    inventorySlots: 14,
    spellSlots: 2,
    baseHp: 125,
    baseMana: 25,
  ...
  },
  {
    ...
    armor: 'Light armor',
    identity: 'Mages are the hot shots of Calostrynn, their pride and joy. They pack a punch, much like the rangers, but what the rangers have in range and recon, the mages more than make up for in versatility. With enough knowledge, there is nearly a spell for almost all occasions.',
    inventorySlots: 10,
    spellSlots: 10,
    baseHp: 70,
    baseMana: 100,
  ...
  },
  {
    ...
    role: 'Hybrid · Poor sustain',
    armor: 'Medium armor',
    identity: 'Mendrunners are a unique lot. They specialize in botany and natural remedies, resenting magic and its simple lifestyle. They are incredibly nimble and many have once been or sometimes become rogues. Little is known about them though due to their lack of number.',
    inventorySlots: 20,
    spellSlots: 0,
    baseHp: 85,
    baseMana: 0,
  ...
  },
  {
    ...
    role: 'Attack · Poor sustain',
    armor: 'Light armor',
    identity: 'Ranged class is known for being a backline attack type. They can pack a punch and provide great support from range, and can even act as very nice recon, but are very vulnerable alone in most situations. A master archer especially has been the sole reason for many conclusions to wars, a much under appreciated craft, given their grand role in previous wars.',
    inventorySlots: 15,
    spellSlots: 1,
    baseHp: 90,
    baseMana: 50,
  ...
  },
  {
    ...
    role: 'Attack · Poor sustain',
    armor: 'Light armor',
    identity: 'Rogues are shifty and cunning. They might not be strong in groups but are amazing duelists and specialize in catching enemies off guard. Their reputation precedes them, and not always in the best of ways, but they are always more than nice outside and within the castle walls.',
    inventorySlots: 16,
    spellSlots: 3,
    baseHp: 90,
    baseMana: 50,
  ...
  },
  {
    ...
    role: 'Hybrid · Decent sustain',
    armor: 'Medium armor',
    identity: 'Wardens are your classic Jack-of-all trades master of none. They bring great all around helpfulness and can be plug and play in most settings. Wardens are known for their survival skills and cunning, but are shunned for a lack of a profitable or secure occupation.',
    inventorySlots: 20,
    spellSlots: 3,
    baseHp: 110,
    baseMana: 75,
